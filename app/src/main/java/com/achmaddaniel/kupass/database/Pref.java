...
public class Pref {
	...
	public static void setImportMethod(int method) {
		SharedPreferences.Editor editor = get(mContext).edit();
		editor.putInt("import_method", method);
		editor.apply();
	}
	
	public static int getImportMethod() {
		return get(mContext).getInt("import_method", ConstantVar.IMPORT_JSON);
	}
	...
	public static int getLanguage() {
		return get(mContext).getInt("language", ConstantVar.LANG_DEF);
	}
