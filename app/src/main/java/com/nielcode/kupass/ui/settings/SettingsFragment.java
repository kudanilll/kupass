...
public class SettingsFragment extends PreferenceFragmentCompat {
  ...
  private void setPreferenceListener() {
    ...
    version.setOnPreferenceClickListener(
        (preference) -> {
          requireActivity()
              .startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(BuildConfig.GIT_URL)));
          return true;
        });
    ...
    dev.setOnPreferenceClickListener(
        (preference) -> {
          requireActivity()
              .startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse(BuildConfig.DEV_URL)));
          return true;
        });
  }
  ...
  private void dialogRestart() {
    new MaterialAlertDialogBuilder(requireActivity())
        ...
        .setPositiveButton(
            requireActivity().getString(R.string.restart),
            (dialog, which) -> {
